...
function setup() {
  ...
  girl = createSprite(50,height - 90,20,50); 
  girl.addAnimation("running", girl_running);
  // girl.addAnimation("collided", trex_collided);
  girl.scale = 0.5;
  ...
  gameOver = createSprite(width/2, height/2,300,100);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(width/2, height/2,300,140);
